...
export { TokenLaunchesService } from './services/token-launches.service';
export { ContractInstancesService } from './services/contract-instances.service';
...
export { TokenLaunchesRepository } from './repositories/token-launches';
